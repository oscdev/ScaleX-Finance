...
"[project]/src/lib/safeFetch.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const DEFAULT_USER_ERROR = 'An unexpected error occurred. Please try again later.';
...
function userFacingError(err, fallback = DEFAULT_USER_ERROR) {
...
"[project]/src/lib/loanType.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const LOAN_TYPE_CODES = [
    'PL',
    'BL',
    'HL',
    'LAP'
];
const DEFAULT_LOAN_TYPE = 'PL';
const LABEL_BY_CODE = {
    PL: 'Personal Loan',
    BL: 'Business Loan',
    HL: 'Home Loan',
...
function isLoanTypeCode(value) {
    return LOAN_TYPE_CODES.includes(String(value ?? '').trim().toUpperCase());
}
function normalizeLoanTypeCode(input) {
    const raw = String(input ?? '').trim();
    if (!raw) return null;
    const upper = raw.toUpperCase();
    if (LOAN_TYPE_CODES.includes(upper)) {
        return upper;
    }
...
function coerceLoanTypeCode(input) {
    return normalizeLoanTypeCode(input) ?? DEFAULT_LOAN_TYPE;
}
function loanTypeLabel(codeOrLegacy) {
...
function isBusinessLoanType(loanType) {
    return normalizeLoanTypeCode(loanType) === 'BL';
}
function isPersonalLoanType(loanType) {
    return normalizeLoanTypeCode(loanType) === 'PL';
}
function isHomeLoanType(loanType) {
    return normalizeLoanTypeCode(loanType) === 'HL';
}
function isLapLoanType(loanType) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$safeFetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/safeFetch.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lead$2d$form$2f$LeadFields$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/lead-form/LeadFields.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$loanType$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/loanType.ts [app-client] (ecmascript)");
;
...
function LeadForm({ pageInfo }) {
    ...
    const buildValidationErrors = ()=>{
        ...
        // Conditional fields
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$loanType$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isLapLoanType"])(product)) {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$loanType$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isHomeLoanType"])(product)) {
        ...
        try {
            const payload = {
                data: {
                    ...
                    selectedProduct: formData.selectedProduct ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$loanType$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["coerceLoanTypeCode"])(formData.selectedProduct) : null,
            ...
            if (!res.ok) {
                const errorData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$safeFetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseJsonSafe"])(res);
            ...
            const responseData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$safeFetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseJsonSafe"])(res);
            if (!responseData) {
            ...
            const safeMsg = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$safeFetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userFacingError"])(err, 'An unexpected error occurred. Please try again later.');
            void (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$plSubmissionLogger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logPlSubmission"])({
                form: 'lead',
                event: 'CLIENT_ERROR',
                leadName: formData.fullName,
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                            ...
                            children: [
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$loanType$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loanTypeLabel"])(formData.selectedProduct),
                                " Submitted!"
                            ]
                        }, void 0, true, {
    ...
    const renderFunnelFields = ()=>{
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$loanType$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isPersonalLoanType"])(product)) {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$loanType$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isBusinessLoanType"])(product)) {
...
//# sourceMappingURL=_39fdabdc._.js.map