...
export const PL_PIPELINE = [
  ...
  { step: 8, ruleId: 'PL-FOIR', ruleName: 'FOIR', formula: 'existingTotalEmi / totalMonthlyIncome <= foir' },
  ...
  { step: 12, ruleId: 'PL-CC-UTIL', ruleName: 'Credit card utilization', formula: 'account_type contains Card → CCU; ccOutstanding / ccLimit <= maxCCUtilizationRatio; SKIP when no Card accounts (ccLimit=0 and ccOutstanding=0)' },
  { step: 13, ruleId: 'PL-UNSECURED', ruleName: 'Active open accounts', formula: 'active_unsecured_loan_count (all Active types) <= maxActiveUnsecuredAccount' },
...
export const BL_PIPELINE = [
  ...
  { step: 11, ruleId: 'BL-CC-UTIL', ruleName: 'CCU max (Card)', formula: 'account_type contains Card → CCU; ccOutstanding / ccLimit <= max_cc_utilization_ratio; SKIP when no Card accounts (ccLimit=0 and ccOutstanding=0)' },
  ...
  { step: 15, ruleId: 'BL-UNSECURED', ruleName: 'Active open accounts (6m)', formula: 'active_unsecured_loan_count (all Active types) <= max_active_unsecured_6_months' },
