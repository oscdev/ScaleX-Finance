...
const SECTION_TREE = [
    ...
    },
    {
        ...
        fields: [
            ...
            { key: 'turnover', label: 'Annual Turnover (Lakh)' },
            { key: 'age', label: 'Business Age' },
            { key: 'regProof', label: 'Business Reg Proof' },
            { key: 'regProofs', label: 'Business Reg Proofs' },
            { key: 'auditedBooks', label: 'Audited Books' },
    ...
    },
    {
        ...
        fields: [
            ...
            { key: 'itrYear1', label: 'ITR (1st Year)' },
            { key: 'itrYear2', label: 'ITR (2nd Year)' },
            { key: 'itrYear3', label: 'ITR (3rd Year)' },
            { key: 'auditedBooksDoc', label: 'Audited Books' },
